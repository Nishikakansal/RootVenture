...
const Main = () => {
  ...
  return (
    <section
      id="home"
      className="container mx-auto flex flex-col-reverse md:flex-row justify-between items-center px-4 py-16 md:py-28"
    >
      {/* Left Column */}
      <div className="w-full md:w-1/2 space-y-8">
        ...
        <div className="flex items-center gap-2 bg-gray-100 w-fit px-4 py-2 rounded-full hover:bg-gray-200 transition">
          ...
          <span className="text-sm font-medium text-gray-700">Got an Idea? We Are Listening</span>
        </div>
        ...
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800 leading-snug md:leading-tight">
          ...
          <span className="inline-block relative">
            ...
            <span className="absolute left-0 w-full h-0.5 bottom-0 bg-blue-300/60"></span>
          </span>
        </h1>
