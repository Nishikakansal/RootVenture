...
const features = [
        {
            ...
            description : "Sign up with your email and build your entrepreneur profile. It helps others know who’s behind the idea!"
        },
        {
            icon: "🚀",
            title: "Step 2: Submit Your Idea",
            description: "Fill out a simple form with your startup name, description, industry, and optional images or documents."
        },
        {
            icon: "🌍",
            title: "Step 3: Get Discovered & Feedback",
            description: "Once posted, your idea is visible to the RootVenture community. Other users can view, like, and comment to help your idea grow."
        }
